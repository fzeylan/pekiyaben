...
namespace Emoda.PekiYaBen.Entity.Enums
{
    public class General
    {
        ...
        {
            [Description("Facebook")] Facebook = 0,
            [Description("Google")] Google = 1,
            [Description("Apple")] Apple = 2
        }
        ...
        {
            [Description("Blog")] Blog = 0,
            [Description("Video")] Video = 1,
            [Description("Podcasdt")] Podcast = 2
        }
        ...
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public enum InterviewPaymentType
        {
            [Description("Play Store")] PlayStore = 1,
            [Description("Apple Store")] AppleStore = 2,
            [Description("PayTR")] PayTR = 3
        }
    }
}
