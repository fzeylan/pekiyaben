...
namespace Emoda.PekiYaBen.Entity.Helpers
{
    ...
    public static class DateTimeExtensions
    {
        ...
        {
            return (long)(value.ToUtcDateTime() - new DateTime(1970, 1, 1)).TotalSeconds;
        }
    ...
    public static class EnumerationExtensions
    {
        ...
        public static IList<KeyValuePair<Enum, string>> ToList2<T>() where T : struct
        {
            var type = typeof(T);
            ...
            return Enum.GetValues(type).OfType<Enum>().Select(e => new KeyValuePair<Enum, string>(e, e.GetDescription())).ToArray();
        }
    }
